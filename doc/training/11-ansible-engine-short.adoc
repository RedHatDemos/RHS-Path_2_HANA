...
[ansible@tower-GUID ~]$ ansible webserver,hana1.example.com -i ~/ansible-files/inventory --list-hosts
...
This Playbook makes sure the package containing the Apache webserver is installed on hana0.example.com.
...
Use SSH to make sure Apache has been installed on hana0.example.com.

----
[ansible@tower-GUID ansible-files]$ ssh hana0.example.com rpm -qi httpd
...
----
[ansible@tower-GUID ansible-files]$ ansible hana0.example.com -m command -a 'rpm -qi httpd'
----
...
The next part of the Playbook makes sure the Apache webserver is enabled and started on hana0.example.com.
...
----
[ansible@tower-GUID ansible-files]$ ansible localhost -m uri -a "url=http://hana0.example.com/"
----
...
* Change the apache.yml Playbook to run on servera *and* hana1.example.com.
...
----
----
[ansible@tower-GUID ansible-files]$ ansible localhost -m uri -a "url=http://hana1.example.com/"
----
...
----
[ansible@tower-GUID ansible-files]$ curl http://hana0.example.com
...
----
----
[ansible@tower-GUID ansible-files]$ curl http://hana1.example.com
...
ok: [hana0.example.com] => {
    "msg": "The default IPv4 address of hana0.example.com is 192.168.1.21\n"
}
ok: [hana1.example.com] => {
    "msg": "The default IPv4 address of hana1.example.com is 192.168.1.22\n"
}
...
Expected outcome: The task is skipped on hana0.example.com because it is not in the ftpserver group in your inventory file:
----
[...]
TASK [Install FTP server when host in ftpserver group] *************************
skipping: [hana0.example.com]
changed: [hana1.example.com]
[...]
----
...
----
[ansible@tower-GUID ansible-files]$ scp hana0.example.com:/etc/httpd/conf/httpd.conf .
----
...
curl: (7) Failed connect to hana1.example.com:80; Connection refused
----
----
[ansible@tower-GUID ansible-files]$ curl http://hana1.example.com:8080
...
* Define a variable "listen_port" for the `webserver` group with the value "8080" and another for `hana1.example.com` with the value "80" using the proper files.
...
* Add this line to `host_vars/hana1.example.com`:
----
listen_port: 80
----
...
----
----
[ansible@tower-GUID ansible-files]$ curl http://hana1.example.com:80
<body>
<h1>This is a production webserver, take care!</h1>
</body>
----
----
[ansible@tower-GUID ansible-files]$ curl http://hana0.example.com:8080
<body>
<h1>This is a development webserver, have fun!</h1>
</body>
----
